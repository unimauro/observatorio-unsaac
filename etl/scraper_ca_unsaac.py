#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Consulta Amigable MEF -> serie histórica pliego 511 (U.N. DE SAN ANTONIO ABAD DEL CUSCO).
Drill: Año -> Nivel de Gobierno -> E: GOBIERNO NACIONAL -> Sector 10 EDUCACION -> Pliego 511.
Parsea PIA/PIM/Certificado/Comprometido/Devengado/Girado de la fila 511.
Guarda raw en ca_unsaac_raw.json. El merge lo hace merge_presupuesto.py.
Adaptado del scraper de San Marcos (pliego 510).
"""
...
def main():
    ...
    json.dump({str(y): r for y, r in results.items()},
              open(os.path.join(HERE, "ca_unsaac_raw.json"), "w"), ensure_ascii=False)
